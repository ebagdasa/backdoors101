...
class ImageHelper(Helper):
    ...
    def load_imagenet(self):
        ...
        self.train_loader = torch_data.DataLoader(self.train_dataset, batch_size=self.batch_size, pin_memory=True,
                                                        shuffle=True, num_workers=2)
        self.test_loader = torch_data.DataLoader(self.test_dataset, batch_size=self.test_batch_size, pin_memory=True,
                                                       shuffle=False, num_workers=2)
