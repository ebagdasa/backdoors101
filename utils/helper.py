...
class Helper:
    def __init__(self, current_time, params, name):
        ...
        if self.log:
            ...
            logger.error(f'LINK: <a href="https://github.com/ebagdasa/backdoors/tree/{self.commit}">https://github.com/ebagdasa/backdoors/tree/{self.commit}</a>')
        else:
    ...
    def compute_latent_loss(self, model, inputs, inputs_back, grads=True, **kwargs):
        ...
        loss = torch.nn.functional.relu(back_features - features).mean()
        # try:
